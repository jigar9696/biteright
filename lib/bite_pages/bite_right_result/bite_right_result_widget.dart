...
import 'bite_right_result_model.dart';
export 'bite_right_result_model.dart';

class BiteRightResultWidget extends StatefulWidget {
  const BiteRightResultWidget({
    super.key,
  ...
  static String routeName = 'BiteRight_Result';
  static String routePath = '/biteRightResult';

  @override
  State<BiteRightResultWidget> createState() => _BiteRightResultWidgetState();
}

class _BiteRightResultWidgetState extends State<BiteRightResultWidget>
    with TickerProviderStateMixin {
  late BiteRightResultModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BiteRightResultModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'BiteRight_Result'});
                              ...
                              children: [
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'BITE_RIGHT_RESULT_BarCode_Button_ON_TAP');
                                        logFirebaseEvent(
                                        ...
                                        if (_model.scannedProductDoc != null) {
                                          ...
                                          _model.masterAvoidList = await actions
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'BITE_RIGHT_RESULT_PAGE_CLOSE_BTN_ON_TAP');
