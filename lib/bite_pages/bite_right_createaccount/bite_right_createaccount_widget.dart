...
import 'bite_right_createaccount_model.dart';
export 'bite_right_createaccount_model.dart';

class BiteRightCreateaccountWidget extends StatefulWidget {
  const BiteRightCreateaccountWidget({super.key});

  static String routeName = 'BiteRight_createaccount';
  static String routePath = '/biteRightCreateaccount';

  @override
  State<BiteRightCreateaccountWidget> createState() =>
      _BiteRightCreateaccountWidgetState();
}

class _BiteRightCreateaccountWidgetState
    extends State<BiteRightCreateaccountWidget> {
  late BiteRightCreateaccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BiteRightCreateaccountModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'BiteRight_createaccount'});
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          width: double.infinity,
                          child: TextFormField(
                            controller: _model.createEmailAddressTextController,
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'BITE_RIGHT_CREATEACCOUNT_REGISTER_BTN_ON');
                              ...
                              context.pushNamedAuth(
                                  BiteRightDietaryProfileWidget.routeName,
                                  context.mounted);
                            },
                            text: 'Register',
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'BITE_RIGHT_CREATEACCOUNT_CONTINUE_WITH_G');
                            logFirebaseEvent('Button_auth');
                            GoRouter.of(context).prepareAuthEvent();
                            final user =
                            ...
                            context.goNamedAuth(
                                BiteRightHomePageWidget.routeName,
                                context.mounted);
                          },
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'BITE_RIGHT_CREATEACCOUNT_CONTINUE_WITH_P');
                            logFirebaseEvent('Button_navigate_to');

                            context.pushNamed(
                              BiteRightAuth3PhoneWidget.routeName,
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'BITE_RIGHT_CREATEACCOUNT_RichText_a2tpei');
                              logFirebaseEvent('RichText_navigate_to');

                              context.pushNamed(BiteRightLoginWidget.routeName);
                            },
                            child: RichText(
