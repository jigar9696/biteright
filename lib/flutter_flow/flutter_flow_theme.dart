...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color lightVibrantColor = const Color(0xFFB8E8D0);
  late Color mutedColor = const Color(0xFF7E8683);
  late Color lightMutedColor = const Color(0xFFC1DCD1);
  late Color darkMutedColor = const Color(0xFF4C514E);
}
